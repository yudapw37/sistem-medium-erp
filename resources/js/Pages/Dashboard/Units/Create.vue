<template>
    <DashboardLayout>
        ...
        <div class="mb-6">
            <h1 class="text-2xl font-bold text-slate-900 dark:text-white">Tambah Satuan</h1>
            <p class="text-sm text-slate-500 dark:text-slate-400">Tambahkan satuan baru</p>
        </div>
