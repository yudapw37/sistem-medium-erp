<template>
    <DashboardLayout>
        <Head title="Edit Pajak" />

        <div class="mb-6">
            <h1 class="text-2xl font-bold text-slate-900 dark:text-white">Edit Pajak</h1>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select
                                ...
                                class="w-full px-4 py-2 border border-slate-300 dark:border-slate-700 rounded-lg focus:ring-2 focus:ring-primary-500 dark:bg-slate-800 dark:text-white"
                            >
                                <option value="excluded">Diluar Harga</option>
...
const form = useForm({
    ...
    rate: props.tax.rate,
    type: props.tax.type,
    applies_to: props.tax.applies_to,
    account_id: props.tax.account_id || '',
