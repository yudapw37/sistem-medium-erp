<template>
    <DashboardLayout>
        <Head title="Return Penjualan Baru" />

        <div class="mb-6">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-bold text-slate-900 dark:text-white">Return Penjualan Baru</h1>
                    <p class="text-sm text-slate-500 dark:text-slate-400">
                        Buat transaksi Return Penjualan stok baru.
                    </p>
                </div>
                <Button
                    type="link"
