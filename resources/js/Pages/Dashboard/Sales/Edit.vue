            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-sm text-slate-500 dark:text-slate-400">
                        Edit draf transaksi {{ sale.invoice }}.
                    </p>
                </div>
                <Button
                    type="link"
                ...
                <div class="grid grid-cols-1 md:grid-cols-5 gap-6">
                    ...
                    <div class="md:col-span-2 bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 p-6">
                        <div class="flex items-center gap-2 mb-4">
                            ...
                            <h3 class="font-semibold text-slate-900 dark:text-white">Gudang</h3>
                        </div>
                        <InputSelect
                            label=""
                            :data="warehouses"
...
const form = useForm({
    ...
    shipping_cost: props.sale.shipping_cost,
    other_cost: props.sale.other_cost,
    shipping_name: props.sale.shipping_name || '',
    shipping_phone: props.sale.shipping_phone || '',
    shipping_address: props.sale.shipping_address || '',
    sender_name: props.sale.sender_name || '',
    sender_phone: props.sale.sender_phone || '',
    payment_type: props.sale.payment_type || 'cash',
    shipping_type: props.sale.shipping_type || 'pickup',
    discount: props.sale.discount || 0,
    discount_type: props.sale.discount_type || 'amount',
    discount_percent: props.sale.discount_percent || 0,
    event_discount: props.sale.event_discount || 0,
    event_discount_type: props.sale.event_discount_type || 'amount',
    event_discount_percent: props.sale.event_discount_percent || 0,
    event_discount_percent: props.sale.event_discount_percent || 0,
    notes: props.sale.notes || '',
    is_preorder: props.sale.is_preorder,
    preorder_status: props.sale.preorder_status || 'pending',
    estimated_ready_date: props.sale.estimated_ready_date ? props.sale.estimated_ready_date.split('T')[0] : '',
    paid_amount: props.sale.paid_amount || 0,
    items: props.sale.details.map(detail => ({
        product_id: detail.product_id,
        bundle_id: detail.bundle_id,
        title: detail.bundle_id ? detail.bundle.name : detail.product.title,
        barcode: detail.bundle_id ? detail.bundle.code : detail.product.barcode,
        sell_price: detail.sell_price,
        discount: detail.discount || 0,
        qty: detail.qty,
        stock: detail.bundle_id ? detail.bundle.stock : detail.product.stock,
        type: detail.bundle_id ? 'bundle' : 'product'
    })),
});

const selectedCustomer = ref(props.customers.find(c => c.id === props.sale.customer_id) || null);
const selectedWarehouse = ref(props.warehouses.find(w => w.id === props.sale.warehouse_id) || null);
