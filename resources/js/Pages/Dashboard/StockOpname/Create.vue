<template>
    <DashboardLayout>
        <Head title="Stock Opname Baru" />

        <div class="mb-6">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-bold text-slate-900 dark:text-white">Stock Opname Baru</h1>
                    <p class="text-sm text-slate-500 dark:text-slate-400">
                        Buat penghitungan fisik stok gudang.
                    </p>
                </div>
                <Button
                    type="link"
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
            ...
            <div class="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 p-4">
                ...
                <p v-if="!form.warehouse_id" class="text-xs text-amber-600 dark:text-amber-400 mt-2">
                    Pilih gudang untuk memuat semua produk
                </p>
                <p v-else-if="loading" class="text-xs text-blue-600 dark:text-blue-400 mt-2">
                    Memuat produk...
                </p>
