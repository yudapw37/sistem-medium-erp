<template>
    <DashboardLayout>
        <Head title="Laporan Fast Moving" />

        <div class="mb-6">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-bold text-slate-900 dark:text-white">Laporan Fast Moving</h1>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
            <div class="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 p-4">
                <p class="text-sm text-slate-500 dark:text-slate-400">Total Produk Terjual</p>
            ...
            <div class="bg-green-50 dark:bg-green-900/20 rounded-2xl border border-green-200 dark:border-green-800 p-4">
                <p class="text-sm text-green-600 dark:text-green-400">Total Unit Terjual</p>
                <p class="text-2xl font-bold text-green-600 dark:text-green-400">{{ stats.total_sold.toLocaleString() }}</p>
            </div>
        ...
        <div class="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 overflow-hidden">
            <table class="w-full">
                <TableThead>
                    <tr>
                        <TableTh class="w-16 text-center">#</TableTh>
                ...
                <TableTbody>
                    ...
                    >
                        ...
                        <TableTd class="text-right font-bold text-green-600">{{ product.total_sold.toLocaleString() }}</TableTd>
...
const applyFilter = () => {
    router.get(route('reports.fast-moving'), {
