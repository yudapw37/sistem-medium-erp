<template>
    <DashboardLayout>
        <Head title="Tambah Transaksi Nilai Nol" />
        ...
        <div class="mb-6">
            ...
            <h1 class="text-2xl font-bold text-slate-900 dark:text-white">Tambah Transaksi Nilai Nol</h1>
        </div>
        ...
        <form @submit.prevent="submit">
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="space-y-6">
                        ...
                        <div class="p-6">
                            <div class="space-y-3">
                                ...
                                <div class="pt-3 border-t border-slate-100 dark:border-slate-700">
                                    ...
                                    <p v-if="form.type === 'in'" class="text-[10px] text-slate-400 mt-1 italic">
                                        * Untuk bonus, nilai total akan masuk sebagai pendapatan lain-lain
                                    </p>
                                    <p v-else class="text-[10px] text-slate-400 mt-1 italic">
                                        * Untuk rusak/expired, nilai total akan masuk sebagai beban kerugian
                                    </p>
                                </div>
                            </div>
                    ...
                    <div class="bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-900/30 p-4 rounded-2xl">
                        <div class="flex gap-3">
                            <IconAlertCircle class="text-amber-600 shrink-0" :size="20" />
                            <div class="text-xs text-amber-800 dark:text-amber-400 space-y-2">
                                <p class="font-bold">Informasi Akuntansi</p>
                                <p>Transaksi ini akan mengurangi/menambah stok tanpa ada kas yang keluar atau masuk.</p>
                                <p>Sistem akan otomatis mencatat jurnal beban/pendapatan berdasarkan nilai HPP saat difinalisasi.</p>
                            </div>
                        </div>
                    </div>
                </div>
...
const submit = () => {
    form.post(route('zero-value-transactions.store'), {
        onSuccess: () => {
            // Success handling via Inertia
        },
    });
};
</script>
