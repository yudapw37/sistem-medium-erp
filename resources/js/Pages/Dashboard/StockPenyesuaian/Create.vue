<template>
    <DashboardLayout>
        <Head title="Stock Penyesuaian Baru" />

        <div class="mb-6">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-bold text-slate-900 dark:text-white">Stock Penyesuaian Baru</h1>
                    <p class="text-sm text-slate-500 dark:text-slate-400">
                        Buat penyesuaian stok (stok awal, koreksi selisih)
                    </p>
                </div>
                <Button
                    type="link"
...
const submit = () => {
    form.post(route('stock-penyesuaian.store'));
};
